    ...
    function (e) {
        if (e.note.name == "C") {
            if (e.note.octave == "2") {
                ...
                document.getElementById("color").innerHTML = "Red" + e.note.name + e.note.octave;
            } else if (e.note.octave == "3") {
                console.log("Green Pressed");
                document.getElementById("color").innerHTML = "Green" + e.note.name + e.note.octave;
            } else if (e.note.octave == "4") {
                console.log("Blue Pressed");
                document.getElementById("color").innerHTML = "Blue" + e.note.name + e.note.octave;
            } else if (e.note.octave == "5") {
                console.log("Yellow Pressed");
                document.getElementById("color").innerHTML = "Yellow" + e.note.name + e.note.octave;
            } else if (e.note.octave == "6") {
                console.log("Spin Pressed");
                document.getElementById("color").innerHTML = "Spin" + e.note.name + e.note.octave;
            }
        }
    }
  );
